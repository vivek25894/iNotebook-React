                        ...
                        <div className="modal-body">
                            <form className="my-3">
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="etitle" name="etitle" onChange={onChange} value={note.etitle} aria-describedby="emailHelp" minLength={5} required />
                                </div>
                                <div className="mb-3">
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" onChange={onChange} name="etag" value={note.etag} id="etag" />
                                </div>
                            </form>
                        </div>
